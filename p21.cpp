...
void Toll_Plaza::enterBike()
{
    ...
    cout<<"\nToll of this bike is : 500 BDT............. Please collect it.........."<<endl;
...
void Toll_Plaza::display()
{
    ...
    else
    {
        ...
        {
            cout<<i+1<<" . Brand : "<<bike_name[i]<<"\t"<<"Bike model : "<<bike_model[i]<<"\t"<<"Toll amount : "<<toll_bike[i]<<endl;
            sum = sum + toll_bike[i];
            print();
        }
        cout<<"\nTotal entered Byke : "<<bikecount<<endl;
